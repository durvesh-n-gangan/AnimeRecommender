...
def get_anime_prompt():
    """
    Create a prompt template for anime recommendations.
    
    Returns:
        PromptTemplate: A template for generating anime recommendations
    """
    template = """You are an expert anime recommender. Your job is to help users find the perfect anime based on their preferences.
